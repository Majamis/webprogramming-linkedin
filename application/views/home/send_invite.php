        ...
        <div id="body" class="" role="main">
            ...
            <div class="wrapper2">
                <div id="main" class="iwe">
                    <div class="contain">
                        <div class="iwrite">
                            <form action="<?php echo base_url();?>index.php/common/page/send_contact_request/<?php echo $userid?>" novalidate method="POST" name="sendrequest" id="connect">
                            <div class="iwrite-in">
                                    ...
                                    <div class="ipaper-in">
                                        <div class="wrap">
                                            ...
                                            <ul id="main-options">
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="1" id="selector-reason" class="radio-btn colleagues">
                                                        <label class="colleague">Colleague</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="2" id="selector-reason" class="radio-btn colleagues">
                                                ...
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="3" id="selector-reason" class="radio-btn colleagues">
                                                        <label class="colleague">We've done business together</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="4" id="selector-reason" class="radio-btn colleagues">
                                                        <label class="colleague">Friend</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="5" id="selector-reason" class="radio-btn colleagues">
                                                        <label class="colleague">Other</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list-item">
                                                        <input type="radio" name="reason" value="6" id="selector-reason" class="radio-btn colleagues">
...
- <?php echo $this->session->userdata('fname') ." ". $this->session->userdata('lname')?></textarea>
                                        </div>
                                    </div>
                                </div>
